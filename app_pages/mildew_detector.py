...
def mildew_detector_body():
    ...
    """
    st.info(
        "* This page will examine Business Requirement 2.\n"
        "* The client is interested in telling whether a "
        "leaf has powdery mildew or not."
    )

    st.write(
        "* You can download a set of healthy and infected leaves for "
